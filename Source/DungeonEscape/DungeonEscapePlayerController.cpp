...
void ADungeonEscapePlayerController::SetupInputComponent()
{
	...
	if (IsLocalPlayerController())
	{
		...
		if (UEnhancedInputLocalPlayerSubsystem* Subsystem = ULocalPlayer::GetSubsystem<UEnhancedInputLocalPlayerSubsystem>(GetLocalPlayer()))
			//tutaj w tym IF bierzemy wszystkie konteksty mapowania które przypisaliœmy do klasy BP opartej na tej klasie c++ w edytorze i dodajemy je wszystkie do gry
		{
